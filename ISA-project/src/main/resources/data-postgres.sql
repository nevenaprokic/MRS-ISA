...
/*ADVENTURE*/
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations, number_of_quick_reservations, number_of_modify) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u pecanju ribe.','Pecanje na Ibru',5,600,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',7, 3, 2, 0);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations, number_of_quick_reservations, number_of_modify) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Pecanje kao vid opustanja','Avantura na Tisi',10,120,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',8, 2, 0, 0);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations, number_of_quick_reservations, number_of_modify) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u zvucima talasanja vode!','Avantura na Dunavu',3,500,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',9, 0, 0, 0);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations, number_of_quick_reservations, number_of_modify) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u zvucima talasanja vode!','Avantura na Savi',3,500,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',10, 0, 0, 0);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations, number_of_quick_reservations, number_of_modify) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u zvucima talasanja vode!','Mušičarenje',3,500,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',10, 3, 0, 0);

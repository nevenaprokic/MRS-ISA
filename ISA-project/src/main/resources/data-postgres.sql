...
/*COTTAGE*/
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Sjajan pogled na sumu i planinu! U blizini se nalazi ski staza.','Vikendica Raj',2,30,'Nije dozvoljeno bilo kakvo unistavanje imovine.',1, 20);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Sjajan pogled na sumu i planinu!','Brvnara',4,40,'Nije dozvoljeno bilo kakvo unistavanje imovine.',2, 14);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u miru i tisini u prirodi.','Jela',3,25,'Nije dozvoljeno bilo kakvo unistavanje imovine.',3, 1);
...
/*SHIP*/
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Bela jahta na obali Dunava','Galeb',2,60,'Nije dozvoljeno bilo kakvo unistavanje imovine.',4, 0);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivanje krstarenjem Dunava uz prijatnu palubu i kabinu za odmor.','Bela ladja',15,120,'Nije dozvoljeno bilo kakvo unistavanje imovine.',5, 1);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u zvucima talasanja vode!','Sidro',3,50,'Nije dozvoljeno bilo kakvo unistavanje imovine.',6, 1);
...
/*ADVENTURE*/
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u pecanju ribe.','Pecanje na Ibru',5,6000,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',7, 3);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Pecanje kao vid opustanja','Avantura na Tisi',10,12000,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',8, 2);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u zvucima talasanja vode!','Avantura na Dunavu',3,5000,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',9, 0);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u zvucima talasanja vode!','Avantura na Savi',3,5000,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',10, 0);
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Uzivajte u zvucima talasanja vode!','Mušičarenje',3,5000,'Nije dozvoljeno bilo kakvo unistavanje imovine i prirode.',10, 3);
...
insert into offer(cancellation_conditions, deleted, description, name, number_of_person, price, rules_of_conduct, address_id, number_of_reservations) values ('Dozvoljeno je otkazivanje 3 dana pre.',false,'Objekat Holiday Home Floris nudi smeštaj sa terasom i pogledom na planinu, a nalazi se na oko 6 km od ski-centra Kopaonik. Gosti ove vikendice mogu da koriste vrt, pribor za pripremu roštilja, besplatan WiFi i besplatan privatni parking.','Holiday Home Floris',5,150,'Nije dozvoljeno bilo kakvo unistavanje imovine.',12, 0);
